...
public abstract class ExportTemplateFiles {
    ...
    protected abstract void export(String text);
    protected abstract void printLineFile(String text);
